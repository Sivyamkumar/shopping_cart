...
const products = [
  ...
  new Product({
    imagePath: '/images/elden_ring.png',
    title: 'Elden Ring',
    description: 'Rise, Tarnished, and be guided by grace to brandish the power of the Elden Ring and become an Elden Lord in the Lands Between. Elden Ring features vast fantastical landscapes and shadowy, complex dungeons that are connected seamlessly.',
    price: 60,
  }),
  new Product({
  ...
  new Product({
    imagePath: '/images/god_of_war.png',
  ...
  new Product({
    imagePath: 'https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/990080/library_600x900.jpg',
    title: 'Hogwarts Legacy',
    description: 'Hogwarts Legacy is an immersive, open-world action RPG set in the world first introduced in the Harry Potter books. Now you can take control of the action and be at the center of your own adventure in the wizarding world. Your legacy is what you make of it. Live the Unwritten.',
    price: 60,
  }),
];
...
async function run() {
  try {
    ...
    for (let i = 0; i < products.length; i++) {
      ...
      console.log(`Saved product: ${products[i].title}`);
    }
  } catch (err) {
    console.error(err);
  }
